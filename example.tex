...
\newcommand{\titleCn}{高超声速涡轮喷气发动机研究}
\newcommand{\titleEn}{Research on Hypersonic Turbojet}
\newcommand{\studentName}{千早爱音}
\newcommand{\studentID}{114514}
\newcommand{\schoolName}{羽丘女子学园}
\newcommand{\majorIn}{航空动力}
\newcommand{\tutorName}{长崎素世}
...
\newcommand{\keywordsCn}{高超声速涡轮喷气发动机，S-发动机，预冷技术，进气管理，超燃冲压发动机}
